...
public class DriversMatchingHighestRatedDriversStrategy implements DriverMatchingStrategy {

    private final DriverRepository driverRepository;

    @Override
    public List<Driver> getDrivers(RideRequest rideRequest) {
        return driverRepository.getTopRatedDrivers(rideRequest.getPickupLocation());
    }
}
